...
def decompress_webp_to_tiff(input_file, output_file):
    # Mở tệp WebP đã nén
    ...
    # Giải nén WebP và lưu dưới định dạng GeoTIFF (không có nén)
    ...
    print(f"Đã giải nén tệp WebP và lưu tại: {output_file}")
...
# Ví dụ sử dụng
input_image = 'C:/anhnghiencuu/anhnghiencuu/compressed_image_lossless.webp'  # Đường dẫn đến tệp WebP nén
output_image = 'C:/anhnghiencuu/anhnghiencuu/decompressed_image.tif'  # Đường dẫn đến tệp GeoTIFF sau giải nén

# Giải nén WebP về GeoTIFF
decompress_webp_to_tiff(input_image, output_image)

...
def compress_to_webp_lossy(input_file, output_file, quality=80):
    # Mở tệp ảnh gốc
    ...
    # Tạo tham số cấu hình cho nén WebP
    ...
    print(f"Đã nén ảnh (mất dữ liệu) và lưu tại: {output_file}")
...
output_image_lossy = 'C:/anhnghiencuu/anhnghiencuu/compressed_image_lossy.webp'  # Đường dẫn đến ảnh nén có mất dữ liệu

# Nén có mất dữ liệu
compress_to_webp_lossy(input_image, output_image_lossy, quality=80)
